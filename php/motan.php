...
define('D_CONN_DEBUG', '10.211.55.3:9990'); //for http mesh server
// define('D_CONN_DEBUG', '10.211.55.3:9991'); //for cgi mesh server
// define('D_AGENT_ADDR', '10.75.71.23:9981');
$url_str = 'motan2://127.0.0.1:9783/com.weibo.motan.HelloWorldService?group=motan-server-mesh-example';
...
define('D_CONN_DEBUG', '10.211.55.2:8002');
// define('D_AGENT_ADDR', '10.75.71.23:9981');
$url_str = 'motan2://127.0.0.1:9783/com.weibo.motan.HelloWorldService?group=motan-java-example';
$url = new \Motan\URL($url_str);
$cx = new \Motan\Client($url);
$rs = $cx->Hello(['hello'=>'motan-php']);
if (null === $rs) {
